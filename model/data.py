...
def load_data(train_path: str, dev_path: str, test_path: str, pred_path: str, rel_dict_path: str):
    """
    加载所有数据集，包括train、dev、test、pred以及relation_dictionary

    :param train_path: 训练集路径
    :param dev_path: 验证集路径
    :param test_path: 测试集路径
    :param pred_path: 预测集路径
    :param rel_dict_path: 关系字典路径
    :return:
            data_bundle: 存放所有数据集的 DataBundle类
            rel_vocab: 关系字典
    """
    paths = {'train': train_path, 'dev': dev_path, 'test': test_path, 'pred': pred_path}
